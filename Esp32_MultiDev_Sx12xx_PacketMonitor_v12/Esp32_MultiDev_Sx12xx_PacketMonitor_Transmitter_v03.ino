...
/*
Version Management
11.02.2025 V03 Additional LoRa board: LilyGo T3S3 SX1262 board
...
const String PROGRAM_VERSION = "PacketMonitor Transm. V03";
...
void setup() {
  ...
  Serial.println(F("ESP32 MD LoRa Packet Monitor Transmitter V03"));
