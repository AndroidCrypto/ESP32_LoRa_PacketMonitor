...
#define MAXIMUM_BYTES_TO_PRINT_OLED 32 // number of bytes of packet to print on an OLED display
#define MAXIMUM_BYTES_TO_PRINT_TFT 96  // number of bytes of packet to print on a TFT display
